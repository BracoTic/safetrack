// views/menu_especial_screen.dart
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart'; // ⬅️ necesario para .listenable()

import '../models/cliente_usuario.dart';
import '../models/reporte.dart'; // ⬅️ para escuchar cambios de reportes
import '../models/ranking.dart'; // ⬅️ para escuchar cambios de rankings

import '../controllers/menu_especial_controller.dart';
import '../controllers/usuario_detail_controller.dart';
import '../widgets/detalle_usuario_popup.dart';

class MenuEspecialScreen extends StatelessWidget {
  final ClienteUsuario clienteUsuario;

  const MenuEspecialScreen({Key? key, required this.clienteUsuario})
    : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = MenuEspecialController(clienteUsuario);
    ...
    // Oculta "Cerrar Sesión" en el grid (se deja el botón grande de abajo)
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // PANEL INFO USUARIO (con puntos en vivo)
                Container(
  ...
  Widget _buildRangoYMedalla({required bool isMobile}) {
    final reportesListenable =
        Hive.box<Reporte>('reportes').listenable(); // requiere hive_flutter
